...
const createControllerComponent = (displayName, controller) => {
    ...
    class Overlay extends React__default.Component {
        ...
        async present(prevProps) {
            const _a = this.props, cProps = tslib.__rest(_a, ["isOpen", "onDidDismiss"]);
...
const createOverlayComponent = (displayName, controller) => {
    ...
    class Overlay extends React__default.Component {
        ...
        async present(prevProps) {
            const _a = this.props, cProps = tslib.__rest(_a, ["children", "isOpen", "onDidDismiss"]);
            const elementProps = Object.assign(Object.assign({}, cProps), { ref: this.props.forwardedRef, [dismissEventName]: this.handleDismiss });
            const overlay = this.overlay = await controller.create(Object.assign(Object.assign({}, elementProps), { component: this.el, componentProps: {} }));
            if (this.props.forwardedRef) {
                this.props.forwardedRef.current = overlay;
            }
